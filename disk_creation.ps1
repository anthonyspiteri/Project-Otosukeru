...
Format-Volume -DriveLetter R -FileSystem ReFS -AllocationUnitSize 65536 -NewFileSystemLabel "REPO-01" -Confirm:$false

$disk = Get-Disk -Number 3
Set-Disk -InputObject $disk -IsOffline $false
Initialize-Disk -InputObject $disk
New-Partition $disk.Number -UseMaximumSize -DriveLetter S
Format-Volume -DriveLetter S -FileSystem ReFS -AllocationUnitSize 65536 -NewFileSystemLabel "REPO-02" -Confirm:$false
